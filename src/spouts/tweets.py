...
class Tweets(Spout):
    ...
    def initialize(self, stormconf, context):
        ...
        stream.filter(languages=["es"], track=["Capriles", "Maduro", "Cabello", "Chavistas", "chavista", "oposición", "opositor", "cambio", "capriles", "asamblea"]&locations=[12.29,-73.30, 0.61,-59.58], async=True)
